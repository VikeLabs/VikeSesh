...
def seed():
    ...
    # Public event — all MATH 100 members see this pin
    ...
    for event, group in [
        (midterm_review,   math100),
        (weekly_study,     math100),
        (chess_tournament, chess_club),
    ]:
    ...
    midterm_alice = (
        ...
        .filter_by(event_id=midterm_review.id, student_id=alice.id)
        .first()
    )
    if midterm_alice:
